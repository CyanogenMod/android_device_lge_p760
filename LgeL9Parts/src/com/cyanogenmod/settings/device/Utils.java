...
public class Utils {
    private static final String TAG = "LgeL9Parts_Utils";
    private static final String TAG_READ = "LgeL9Parts_Utils_Read";
    private static final String TAG_WRITE = "LgeL9Parts_Utils_Write";
